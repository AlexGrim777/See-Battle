...
class BoardOutException(Exception):
    ...
    def __init__(self, message=None):
        if message:
            ...
            self.message = 'Выстрел за пределы игрового поля !'
...
class SamePointException(Exception):
    ...
    def __init__(self, message=None):
        if message:
            ...
            self.message = 'Выстрел в ту же точку !'
...
class Ship:
    ...
    SHIP_DESCRIPTION = {'1': 'одномачтовый корабль', '2': 'двухмачтовый корабль', '3': 'трехмачтовый корабль'}
...
class Game:
    ...
    def greet(self):
        print('\nМОРСКОЙ БОЙ')
        print('-'*20)
        print('\nНа поле 6х6 клеток размещается 7 кораблей - один трехмачтовый, два двухмачтовых и четыре',
              'одномачтовых.')
        print('Корабли расставляются на поле автоматически в рандомном порядке.')
        print('Вы ходите первым, а дальше компьютер и так по новой до победы вас или компьютера.')
                ...
                while self.user_board.ship_afloat and self.ai_board.ship_afloat:
                    ...
                    if ship:
                        if not ship.lives:
                            ...
                            print('\nПападание ! Корабль противника подбит, но еще не уничтожен !')
